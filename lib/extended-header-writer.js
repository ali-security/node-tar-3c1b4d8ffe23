...
function encodeFields (fields, prefix, body, nop) {
  ...
  Object.keys(fields).forEach(function (k) {
    ...
    switch (k) {
      ...
      case "size":
        // never write out a size below zero: a reader that honored it would
        // count the entry's remaining bytes down from a negative number, never
        // reach the end of the entry, and lose the rest of the archive.
